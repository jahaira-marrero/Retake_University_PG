...
milo = Student.create(name: "Milo", age: 20, major: "Archeology")
buford = Student.create(name: "Buford", age: 20, major: "Undeclared")
shooter = Student.create(name: "Shooter", age: 20, major: "Business")
